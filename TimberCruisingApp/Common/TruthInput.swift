...
public enum TruthInput {
    ...
    public static func warning(base: Double, quantity: Quantity) -> String? {
        switch quantity {
        case .diameter: return dbhWarning(cm: base)
        case .height: return heightWarning(m: base)
    ...
    public static func fieldWarning(_ raw: String,
        ...
        return warning(base: base, quantity: quantity)
    }
