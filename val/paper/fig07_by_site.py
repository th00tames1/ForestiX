...
cap = (
    ...
    "higher at Starker in two of the four cells (Android DBH 3.7 vs 5.0 cm, "
    "Android height 1.7 vs 2.5 m) and lower in the other two, and the "
    "corresponding percent contrasts are null, so the field-unit gaps track "
    "stem size rather than stand. Stand and stem "
    "size are confounded by design - Starker stems average 55.5 cm and "
    "38.9 m against McDunn's 43.4 cm and 21.3 m - and stand is also "
    ...
    "raises iOS height to +5.4 pp (p = 0.022); restricting to the 10.5-44.1 m "
    ...
    "stand effect. Diameters in centimetres against a diameter tape, heights in "
    "metres against a laser rangefinder in 3-point mode; n = 50 stems per stand "
    "Excluding the 6 stems with a disputed tape "
    "value - 5 of them McDunn diameters - leaves every contrast "
...
core.save_table(out.round(4), "t07_by_site", (
    ...
    "the two stands share. Diameters in centimetres, heights in metres."
))
